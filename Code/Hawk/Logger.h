...
#define LOG_MOD(msg, level)							LOG_WITH_SOURCE_INFO(msg, this->GetName(), level)
#define LOG_MOD_IF(p, msg, level)					if ((p)) LOG_MOD(msg, level)

#define LOG_EXCEPTION(e, module, level)				LOG_EXCEPTION_WITH_SOURCE_INFO(e, module, level);
#define LOG_MOD_EXCEPTION(e, level)					LOG_EXCEPTION_WITH_SOURCE_INFO(e, this->GetName(), level);

#define LOG_STD_EXCEPTION(e, module, level)			LOG_WITH_SOURCE_INFO(e.what(), module, level);
#define LOG_MOD_STD_EXCEPTION(e, level)				LOG_WITH_SOURCE_INFO(e.what(), this->GetName(), level);
...
#define LOG_MOD(msg, level)	
#define LOG_MOD_IF(p, msg, level)

#define LOG_EXCEPTION(e, module, level)		
#define LOG_MOD_EXCEPTION(e, module, level)		

#define LOG_STD_EXCEPTION(e, module, level)
#define LOG_MOD_STD_EXCEPTION(e, module, level)
