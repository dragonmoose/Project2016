...
void BaseFactory::CreateCommandQueue(ID3D12Device* p_pDevice, CommandQueueComPtr_t& p_CommandQueue)
{
...
void BaseFactory::CreateSwapChain(IDXGIFactory4* p_Factory, ID3D12CommandQueue* p_CommandQueue, SwapChainComPtr_t& p_SwapChain)
{
	...
	l_Desc.BufferCount = c_uiNumBackBuffers;
...
void BaseFactory::CreateCommandAllocator(ID3D12Device* p_pDevice, CommandAllocatorComPtr_t& p_Allocator)
{
